...
export SPARK_CLASSPATH+=:/root/tachyon/target/tachyon-0.3.0-jar-with-dependencies.jar
export ADD_JARS=/root/tachyon/target/tachyon-0.3.0-jar-with-dependencies.jar
